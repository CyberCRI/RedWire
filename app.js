...
(function() {
  var CODE_CHANGE_TIMEOUT, MODEL_FORMATTING_INDENTATION, MessageType, SPINNER_OPTS, adjustEditorToSize, automaticallyUpdatingModel, clearCodeInCache, clearMessage, currentActions, currentAssets, currentFrame, currentLayout, currentLoadedAssets, currentModel, currentModelData, currentServices, currentTools, editors, executeCode, getFormattedTime, globals, handleAnimation, handleResize, isPlaying, loadCodeFromCache, loadIntoEditor, log, logWithPrefix, notifyCodeChange, registerService, reloadCode, requestAnimationFrame, resetLogContent, saveCodeToCache, services, setCodeFromCache, setupButtonHandlers, setupEditor, setupLayout, showMessage, spinner, zeroPad;
  ...
  */
  ...
  reloadCode = function(callback) {
    var error, service, serviceDef, serviceDefs, serviceName,
      _this = this;
