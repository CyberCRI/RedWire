...
(function() {
  ...
  */
  ...
  reloadCode = function(callback) {
    var service, serviceDef, serviceDefs, serviceName,
      _this = this;
    try {
  ...
  */
  ...
  $(document).ready(function() {
    ...
    if (!loadedCode) {
      _ref1 = [["modelEditor", "optics/model.json"], ["assetsEditor", "optics/assets.json"], ["actionsEditor", "optics/actions.js"], ["layoutEditor", "optics/layout.json"], ["servicesEditor", "optics/services.json"]];
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        _ref2 = _ref1[_j], id = _ref2[0], url = _ref2[1];
        loadIntoEditor(editors[id], url);
      }
    }
    _ref3 = ["modelEditor", "assetsEditor", "actionsEditor", "layoutEditor", "servicesEditor"];
