...
(function() {
  ...
  GE.NodeVisitorConstants = NodeVisitorConstants = (function() {
    function NodeVisitorConstants(modelData, serviceData, assets, actions, tools, log) {
  ...
  GE.sandboxActionCall = function(node, constants, bindings, methodName, signals) {
    var action, childNames, compiledParams, defaultValue, e, evaluatedParams, locals, methodResult, paramName, paramValue, result, _i, _ref, _ref1, _results;
  ...
  GE.visitCallNode = function(node, constants, bindings) {
    var compiledParams, e, evaluatedParams, param, parameter;
  ...
  GE.stepLoop = function(node, modelData, assets, actions, tools, services, log, inputServiceData, outputServiceData) {
